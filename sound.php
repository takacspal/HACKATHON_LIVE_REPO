...
?><html>
    <head>
        ...
        <script>
            ...
            $(function () {
                $(document).on("click", "#cmajor", function () {
                    playNote('c');
                    playNote('c');
                    playNote('e');
                    playNote('g');
                });
                $(document).on("click", "#gmajor", function () {
                    playNote('g');
                    playNote('b');
                    playNote('d');
                });
                $(document).on("click", "#dminor", function () {
                    playNote('d');
                    playNote('f');
                    playNote('a');
                });
                $(document).on("click", "#aminor", function () {
                    playNote('a');
                    playNote('c');
                    playNote('e');
                });
    ...
    <body>
        ...
        <?php foreach (glob("sound/*.mp3") as $sound): ?>
            <?php
            $soundProps = NULL;
            //bb1_piano_120
            ...
            ?>
            <?php echo $soundName . $soundPitch; ?>&nbsp;<audio class="single-sound" id="<?php echo $soundName; ?>" src="<?php echo $sound; ?>" controls preload="auto" autobuffer data-pitch="<?php echo $soundPitch; ?>" data-instrument="<?php echo $instrument; ?>" data-bpm="<?php echo $sampleBpm; ?>"></audio>
            <br />
        <?php endforeach; ?>
        ...
        <textarea>szövegből csinálunk egy számot vagy variációt, ismétlésnél ismétlés szerű, mintegy szövegesen leírt dallam, zene</textarea>
